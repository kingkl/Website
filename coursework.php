...
<!--right column - Main Content - Home page - Introduction to site-->	
	<div id="rightcolumn">
		...
		<div class="content coursework">
			<h2>Gwinnett Technical College Coursework</h2>
			<div class="topborder">&nbsp;</div>
			<div><h3>FALL 2015</h3>
				<div class="shapeCircleOutside floatright1 positionRelative2"><div class="shapeCircle">&nbsp;</div></div>
				<ul>
			...
			<div><h3 class="midborder">SUMMER 2015</h3>
				<div class="squareBox floatright1 positionRelative3"><span class="shapeSquare">&nbsp;</span></div>
				<ul>
					<li><span class="title-font"><a href="cist2351/index.html">CIST2351</a></span> - PHP Programming I</li>
				</ul>
			</div>
			<div><h3 class="midborder">SPRING 2015</h3>
				<div class="shapeParallelogram floatright1 positionRelative2">&nbsp;</div>
				<ul>
			...
			<div><h3 class="midborder">FALL 2014</h3>
				<div class="borderBox floatright1 positionRelative1"><span class="shapeBorder">&nbsp;</span></div>
				<ul>
			...
			<div><h3 class="midborder">SUMMER 2014</h3>
				<div class="shapeMisc floatright1 positionRelative2">&nbsp;</div>
				<ul>
			...
			<div><h3 class="midborder">SPRING 2014</h3>
				<div class="shapeBigSquareOutSide floatright1"><div class="shapeSquareRotated">&nbsp;</div></div>
				<ul>
