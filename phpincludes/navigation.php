		...
		<ul id="mobileNav">
			<li><button type="button" class="menuBtn">Menu&nbsp;
				...
				<ul id="nav">
					...
					<li <?php if ($thisPage=="Porfolio") echo " id=\"currentpage\""; ?>><a href="portfolio.php">Portfolio <small>&#x25BC;</small></a>
						<ul class="dropdown">
							<li class="bottomddb3 ddtitle"><a href="portfolio.php#websites">WEBSITE DESIGN<br><span class="arrowLeft"> &#x25C4; </span><small class="arrowDownL"> &#x25BC; </small><small class="arrowDown"> &#x25BC; </small><span class="arrowRight"> &#x25BA; </span></a>
								<ul class="dropdown2">
							...
							<li class="topddb ddtitle"><a href="portfolio.php#imgEdits">DIGITAL IMAGE<br><span class="arrowLeft"> &#x25C4; </span><small class="arrowDownL"> &#x25BC; </small>EDITING & REPAIR <small class="arrowDown"> &#x25BC; </small><span class="arrowRight"> &#x25BA; </span></a>
								<ul class="dropdown3">
							...
							<li class="topddb ddtitle"><a href="portfolio.php#CSS-JS">CSS & JAVASCRIPT<br><span class="arrowLeft"> &#x25C4; </span><small class="arrowDownL"> &#x25BC; </small>EXAMPLES<small class="arrowDown"> &#x25BC; </small><span class="arrowRight"> &#x25BA; </span></a>
								<ul class="dropdown4">
